...
// Add individual order PDF generation function - Professional Receipt Version
const handleDownloadOrderPDF = async (order) => {
  try {
    ...
    try {
      const logoUrl = "/logo.jpeg"; // Replace with your logo
    ...
    // Company Name and Title - positioned to the right of the logo
